  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          className={`absolute z-50 px-3 py-1.5 text-xs font-medium text-white bg-gray-800 rounded-lg shadow-lg whitespace-nowrap pointer-events-none animate-fade-in ${positionClasses[position]}`}
          role="tooltip"
        >
          {content}
